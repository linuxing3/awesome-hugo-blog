...
title: "using-python-in-emacs.org"
author: "Xing Wenju"
...
|-------------+-------------------------------------------------|
| ~SPC m V a~ | 激活任何目录下的虚拟环境 activate a virtual environment in any directory |
| ~SPC m V d~ | 停止虚拟环境 deactivate active virtual environment    |
| ~SPC m V w~ | 在 WORKON 目录工作 work on virtual environment in =WORKON_HOME= |
