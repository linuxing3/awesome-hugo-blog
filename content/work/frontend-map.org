...
marked `DONE`. By default tasks are archived under the heading `* Archived Tasks` in the archive file.
...
backup solution. At the time I said `I'm not going to lose any important data ever again`. So far so good :)
